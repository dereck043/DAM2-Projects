...
import es.system.pokemongo.databinding.FragmentItemListBinding;
import es.system.pokemongo.databinding.ItemListContentBinding;

import es.system.pokemongo.placeholder.PlaceholderContent;
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) {
                if (response.isSuccessful()) {
                    ArrayList pokemonList =((PokemonFetchResults) response.body()).getResults();
                    PokemonAdapter adapter = new PokemonAdapter(getContext(),
                            R.layout.fragment_item_list, pokemonList);
